        ...
        return (
            <div className='mobile-menu-wrapper'>
                ...
                <div className='mobile-menu'>
                    ...
                    <NavLink className='item clickable' activeClassName='active' to='/pool' onClick={onDismiss}>Pool</NavLink>
                    <NavLink className='item clickable' activeClassName='active' to='/zap' onClick={onDismiss}>Zap</NavLink>
